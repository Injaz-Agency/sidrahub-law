  ...
  <section>
    <div style="background: url({{ asset('page_bg.jpg') }});background-size: cover; background-position: center;">
      <div class="container py-16 text-center md:py-28">
        ...
        <div class="mx-auto flex items-center justify-center space-x-4 text-white rtl:space-x-reverse">
    ...
    <div class="container py-16">
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-10 xl:grid-cols-4 xl:gap-14">
        <div class="group space-y-3">
          ...
          <h3 class="text-xl font-semibold text-second md:text-2xl ltr:ml-2 rtl:mr-2">عزام ال تركي</h3>
          <p class="text-base font-medium md:text-xl ltr:ml-2 rtl:mr-2">محامي نقد - مكتب عزام للمحاماة</p>
          <div class="py-4">
