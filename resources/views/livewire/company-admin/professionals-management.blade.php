                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                <button wire:click="openViewModal({{ $professional->id }})"
                                ...
                                <button wire:click="openEditModal({{ $professional->id }})"
        ...
        <div class="bg-white rounded-xl p-6 w-full max-w-2xl max-h-screen overflow-y-auto">
            ...
            <div class="space-y-6">
                <div class="flex items-center space-x-4">
                    ...
                    <img src="{{ asset('storage/' . $selectedProfessional->image) }}"
                        alt="{{ $selectedProfessional->name_en }}" class="w-20 h-20 rounded-lg object-cover">
                    @else
