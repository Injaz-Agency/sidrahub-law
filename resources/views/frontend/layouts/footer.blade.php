<section>
  <div class="container">
    <div class="flex items-center flex-wrap py-6 md:py-10 px-8 md:px-20 bg-main/90 rounded-xl space-y-4 md:space-y-0">
      <div class="w-full md:w-8/12">
        <h2 class="text-xl md:text-5xl text-center md:text-start leading-relaxed md:leading-relaxed text-white">@lang('Conduct a free consultation with Sidra Business Services platform specialists')</h2>
      </div>
      <div class="w-full md:w-4/12 flex justify-center md:justify-end">
        <a href="{{ route('frontend.consulting.register') }}" class="flex items-center justify-center py-3 px-8 text-base text-white bg-second rounded-xl">
  ...
  <div class="container pt-10 lg:pt-16">
    <div class=" grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-10">
      <div>
        ...
        <p class="my-4 lg:text-lg text-center lg:text-start">@lang('Welcome to Sidra, your trusted partner for unparalleled success in legal, financial and business establishment services.')</p>
      </div>
      <div>
        <h4 class="mb-4 text-xl lg:text-2xl text-second font-medium">@lang('Our services')</h4>

        <ul class="list-none mt-6 space-y-2 md:space-y-4">
      ...
      <div class="lg:col-span-2">
        <h4 class="mb-4 text-xl lg:text-2xl text-second font-medium">@lang('Our Branches')</h4>
            ...
            <ul class="list-none mt-2 space-y-4">
              <li>
                <a href="" class="flex items-center text-base">
                  <span class="inline-flex">
                    <svg class="w-6 h-6 lg:w-8 lg:h-8 fill-second" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                      <path
              ...
              <li>
                <a href="https://api.whatsapp.com/send?phone=966582322777" target="_blank" class="flex items-center text-base">
                  <span class="inline-flex">
                    <svg class="me-4 w-6 h-6 lg:w-8 lg:h-8 fill-second" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                      <path
    ...
    <div class="mt-10 py-8 flex flex-col md:flex-row items-center justify-center md:justify-between border-t border-sh-border">
      <div>@lang('All Rights Reserved') @lang('To') <span class=" text-second">@lang('Sidra')</span> &copy; 2023</div>

      <ul class="list-none flex items-center justify-center lg:justify-start gap-x-4 lg:gap-x-6 mt-4">
        <li>
          <a href="https://instagram.com/sidra.hub" target="_blank" class="inline-flex">
            <svg class="w-8 h-8 fill-second hover:fill-white transition-all duration-200 ease-linear" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
              <path
        ...
        <li>
          <a href="https://www.facebook.com/sidrahubSa?mibextid=ZbWKwL" target="_blank" class="inline-flex">
            <svg class="w-8 h-8 fill-second hover:fill-white transition-all duration-200 ease-linear" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
              <path
