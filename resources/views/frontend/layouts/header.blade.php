    ...
    <div class="container">
      <div class="relative flex items-center justify-between h-24">
        ...
        <div class="flex-1 flex items-center justify-end lg:justify-start">
          ...
          <div class="flex-1 h-full hidden lg:block ltr:me-6 sm:me-6">
            <div class="h-full flex items-center justify-center">
              ...
              <services-menu :services="{{ json_encode($services) }}" locale="{{ App::currentLocale() }}"></services-menu>
        ...
        <div class="absolute inset-y-0 end-0 flex items-center pe-2 lg:static lg:inset-auto lg:ms-6 sm:pe-0">
          <a href="{{ route('frontend.login') }}" title="@lang('Sign In')"
            class="hidden xl:flex items-center justify-center ms-3 py-3 px-4 text-base bg-second text-white rounded-xl">
