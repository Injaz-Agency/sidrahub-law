{{-- $teams keys => [name, job, photo] --}}
<div id="teamSplide" class="splide mt-10">
  <div class="splide__track">
    <ul class="splide__list">
      {{-- @foreach ($teams as $team) --}}
      {{-- <team :person="{{json_encode($team)}}"></team> --}}
        ...
        <div data- class="group space-y-3">
          <div class="relative">
            <img class="w-full rounded-xl shadow-image transition-all duration-200 ease-linear group-hover:border-4 group-hover:border-second"
              src="https://sidrahub.com/storage/teams/FZzCxghzLosoWS3cJsHq1sqkZ0hbcZTlVQgO0tG9.jpg" alt="">

            <ul class="a bsolute i nset-x-0 bottom-8 flex items-center justify-center space-x-5 rtl:space-x-reverse" style="display: none;">
              <li>
          ...
          <h3 class="text-xl font-semibold text-second md:text-2xl ltr:ml-2 rtl:mr-2">فاطمه مختار</h3>
          <p class="text-base font-medium md:text-lg ltr:ml-2 rtl:mr-2">مستشاره قانونيه</p>
          <div class="py-4">
