<template>
  <div class="relative">
    ...
    <transition name="fade">
      <!-- class="absolute top-12 start-0 min-w-[190px] z-40 mt-2 bg-white border border-gray-200 rounded-md shadow-xl" -->
      <div v-show="isOpen" class="border-t border-sh-border">
